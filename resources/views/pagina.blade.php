...
<head>
	<title>Grupo de Estudios "LearningCuba" </title>
	<meta charset="utf-8">
			...
			<div class="row ftco-animate justify-content-center">
				<div class="col-md-12">
					<div class="carousel-testimony owl-carousel">
						<div class="item">
							<div class="testimony-wrap d-flex">
								...
								<div class="text ml-2">
									...
									<span class="position">Madre de Familia</span>
								</div>
							</div>
						</div>
						<div class="item">
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								<div class="user-img mr-4" style="background-image: url(images/silvana.jpg)">
								</div>
								<div class="text ml-2">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
									...
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live
										the blind texts.</p>
									<p class="name">Silvana Parra - UNAAT</p>
									<span class="position">Ex-alumna - Promoción 2019</span>
								</div>
							</div>
						</div>
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								...
								<div class="text ml-2">
									...
									<span class="position">Alumno</span>
								</div>
							</div>
						</div>
						<div class="item">
